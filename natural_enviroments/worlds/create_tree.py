...
<model name='tree_8_N'>
    ...
    <scale>1 1 1</scale>
    <link name='link_0'>
        <pose frame=''>X Y 100 1.49467 -0 0</pose>
        <velocity>0 0 0 0 -0 0</velocity>
        <acceleration>0 0 0 0 -0 0</acceleration>
        <wrench>0 0 0 0 -0 0</wrench>
    </link>
    <link name='link_1'>
        <pose frame=''>X Y 100 1.57 -0 0</pose>
        <velocity>0 0 0 0 -0 0</velocity>
        <acceleration>0 0 0 0 -0 0</acceleration>
        <wrench>0 0 0 0 -0 0</wrench>
    </link>
...
<model name='tree_8_N'>
      <link name='link_0'>
        ...
        <pose frame=''>0 0 0 1.49467 -0 0</pose>
        <gravity>1</gravity>
...
for n in range(0,400):
	...
	root1.attrib['name'] = f'tree_8_{n}'
	root2.attrib['name'] = f'tree_8_{n}'
	...
	f1=open('/home/kim/catkin_ws/src/natural_environments_ros/natural_enviroments/worlds/tree1.txt','a')
	f1.write(new_xml_text1)
	f1.write("\n")
	f1.close()
	new_xml_text2 = ET.tostring(root2).decode()
	f2=open('/home/kim/catkin_ws/src/natural_environments_ros/natural_enviroments/worlds/tree2.txt','a')
